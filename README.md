...
행안부 · NIA AI 챔피언 사업의 교육 운영 사이클 전체(모집 → 선발 → 수업 → 출결 → 과제 → 수료 → 인증 → 설문 → 진단 → 결과보고)를 한 시스템으로 옮긴 자체 구축 운영 시스템. 2026년 4월부터 운영 중.
...
사내 코드네임은 `kbrain-ems`. 운영자는 사내 담당자, 신청자 · 교육생은 외부 응답자(공무원)다.
